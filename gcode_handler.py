...
class gcode_handler_core:
    ...
    def translate_to_motioncontroller(self, command):
        ...
        for axis in range(len(steps)):
            ...
            message_piece = axis_label+signal+step_str
...
#  tester
# gcode_text_example = "G00 Y+200 Z-400;G00 Y+200 Z-400\nG02 Y+200 Z-400\n;G00 Y+200 Z-400;"
# gcode_handler_core_instance = gcode_handler_core()
# messages = gcode_handler_core_instance.translate_gcode(gcode_text_example)
